package muteas19.smallnote.auth;
...
import muteas19.smallnote.MainActivity;
import muteas19.smallnote.R;
...
public class Register extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("SmallNote'a Bağlan");
        ...
        syncAccount.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(uUserEmail.isEmpty() || uUsername.isEmpty() || uUserPass.isEmpty() || uConfPass.isEmpty()){
                    Toast.makeText(Register.this, "Tüm alanlar zorunludur.", Toast.LENGTH_SHORT).show();
                    return;
                }

                if(!uUserPass.equals(uConfPass)){
                    rUserConfPass.setError("Parola Eşleşmedi.");
                }
                ...
                fAuth.getCurrentUser().linkWithCredential(credential).addOnSuccessListener(new OnSuccessListener<AuthResult>() {
                    ...
                    public void onSuccess(AuthResult authResult) {
                        Toast.makeText(Register.this, "Not Senkronize Edildi.", Toast.LENGTH_SHORT).show();
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(Register.this, "Bağlantı başarısız, tekrar deneyin .", Toast.LENGTH_SHORT).show();
                        progressBar.setVisibility(View.VISIBLE);
                    }
                });
